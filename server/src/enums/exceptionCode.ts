export enum EXCEPTION_CODE {
  ...
  NO_SURVEY_PERMISSION = 3001, // 没有投票权限
  SURVEY_STATUS_TRANSFORM_ERROR = 3002, // 投票状态转换报错
  SURVEY_TYPE_ERROR = 3003, // 投票类型错误
  SURVEY_NOT_FOUND = 3004, // 投票不存在
  SURVEY_CONTENT_NOT_ALLOW = 3005, // 存在禁用内容
  SURVEY_SAVE_CONFLICT = 3006, // 投票冲突
  ...
  RESPONSE_SCHEMA_REMOVED = 9004, // 投票已删除
  RESPONSE_DATA_DECRYPT_ERROR = 9005, // 投票已删除
  RESPONSE_PAUSING = 9006, // 投票已暂停
